...
const DEFAULT_APP_SETTINGS = {
  ...
  tabAccess: {
    ...
    quota: [] as string[],
    tasks: [] as string[],
    tickets_dashboard: [] as string[],
    tickets_my: [] as string[],
    tickets_queue: [] as string[],
    tickets_sla: [] as string[],
    tickets_settings: [] as string[],
    av_schedule: ["av"],
    users: [] as string[],
...
const TabAccessSchema = z.object({
  ...
  tickets_dashboard: z.array(z.string()).default(DEFAULT_APP_SETTINGS.tabAccess.tickets_dashboard),
  tickets_my: z.array(z.string()).default(DEFAULT_APP_SETTINGS.tabAccess.tickets_my),
  tickets_queue: z.array(z.string()).default(DEFAULT_APP_SETTINGS.tabAccess.tickets_queue),
  tickets_sla: z.array(z.string()).default(DEFAULT_APP_SETTINGS.tabAccess.tickets_sla),
  tickets_settings: z.array(z.string()).default(DEFAULT_APP_SETTINGS.tabAccess.tickets_settings),
...
function normalizeAppSettingsRecord(settings: any) {
  ...
  return {
    ...
    tabAccess: {
      ...
      tickets_dashboard: normalizeStringArray(tabAccess.tickets_dashboard || []).map((team) => normalizeTeamName(team).toLowerCase()).filter(Boolean),
      tickets_my: normalizeStringArray(tabAccess.tickets_my || []).map((team) => normalizeTeamName(team).toLowerCase()).filter(Boolean),
      tickets_queue: normalizeStringArray(tabAccess.tickets_queue || []).map((team) => normalizeTeamName(team).toLowerCase()).filter(Boolean),
      tickets_sla: normalizeStringArray(tabAccess.tickets_sla || []).map((team) => normalizeTeamName(team).toLowerCase()).filter(Boolean),
      tickets_settings: normalizeStringArray(tabAccess.tickets_settings || []).map((team) => normalizeTeamName(team).toLowerCase()).filter(Boolean),
